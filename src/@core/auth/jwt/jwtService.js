import { preLogout, initSSO } from '@/auth/utils'
  ...
  constructor(axiosIns, jwtOverrideConfig) {
    ...
    this.axiosIns.interceptors.request.use(
      config => {
        ...
        console.log("accessToken In JWTService", accessToken)
          ...
          if (!this.isAlreadyFetchingAccessToken) {
            ...
            this.refreshToken()
              .then(r => {
                ...
                console.log("JWT SERVICE 401", r.data);
              ...
              .catch(async e => {
                console.log("JWT SERVICE ERROR", e)
                if (e.response) {
                  await preLogout()
  ...
  refreshToken() {
    return this.axiosIns.post(this.jwtConfig.refreshEndpoint, {}, {
      transformRequest: (data, headers) => {
        ...
        console.log("RefrehToken data",data)
        return data
      },
    })
  }
